...
namespace SharedHelpers.DataTransferObjects
{
    public record HamsterForUpdateDto(
        [Required][MinLength(1, ErrorMessage = "We need a name here. Min 1 char.")][MaxLength(20, ErrorMessage = "We need a name here. Max 20 chars.")] string Name,
        [Required][Range(0, 3 ,ErrorMessage = "Age is important, 0 - 3 years.")] int Age,
